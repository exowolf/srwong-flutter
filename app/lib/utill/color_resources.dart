...
class ColorResources {
  ...
  static Color getFooterColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ?  Color(0xFFFFFFFF) :Color(
        0xFF858585);
  }
  static Color getChatAdminColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ?  Color(0xFFa1916c) :Color(
        0xFF1F1F1F);
  }
  ...
  static const Color APPBAR_HEADER_COL0R = Color(0xFF000000);
  static const Color FOOTER_COL0R = Color(0xFFFFFFFF);
  static const Color ARROW_COLOR = Color(0xFF515755);
  static const Color FOOTER_BODY_TEXT_COLOR = Color(0xFFFFFFFF);
