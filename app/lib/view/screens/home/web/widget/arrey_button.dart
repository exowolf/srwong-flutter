...
class ArrayButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(color: isVisible ? Theme.of(context).primaryColor.withOpacity(0.7) : ColorResources.COLOR_WHITE, shape: BoxShape.circle,
          boxShadow: [
            BoxShadow(
        ...
        child: Padding(
          ...
          child: isLeft ? Icon( Icons.chevron_left_rounded, color: isVisible ? ColorResources.COLOR_WHITE
              : ColorResources.COLOR_BLACK, size: isLarge == null || isLarge ?  30
              : Dimensions.PADDING_SIZE_LARGE) : Icon(Icons.chevron_right_rounded, color: isVisible
              ? ColorResources.COLOR_WHITE  :  ColorResources.COLOR_BLACK, size: isLarge == null || isLarge ?  30
