...
import 'package:flutter_pdg/view/screens/home/widget/cart_bottom_sheet.dart';
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            boxShadow: [BoxShadow(
                              color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 900 : 400],
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              placeholder: Images.placeholder_banner, width: 250, height: 111, fit: BoxFit.cover,
                              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.bannerImageUrl}/${banner.bannerList[index].image}',
                              imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder_banner, width: 250, height: 111, fit: BoxFit.cover),
                            ),
                          ),
                        )
                      );
