...
import 'package:flutter_pdg/view/screens/chat/widget/message_bubble.dart';
import 'package:flutter_pdg/view/screens/chat/widget/message_bubble_shimmer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context) ? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(100))
          : AppBar(title: _isAdmin ? Text('${Provider.of<SplashProvider>(context,listen: false).configModel.restaurantName}')
