...
import 'package:flutter_pdg/data/model/response/base/error_response.dart';
import 'package:flutter_pdg/data/model/response/delivery_man_model.dart';
import 'package:flutter_pdg/data/model/response/distance_model.dart';
import 'package:flutter_pdg/data/model/response/order_details_model.dart';
import 'package:flutter_pdg/data/model/response/order_model.dart';
import 'package:flutter_pdg/data/model/response/response_model.dart';
import 'package:flutter_pdg/data/model/response/timeslote_model.dart';
import 'package:flutter_pdg/data/repository/order_repo.dart';
import 'package:flutter_pdg/helper/api_checker.dart';
